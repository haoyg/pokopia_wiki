...
import rawHabitatsData from '@/data/tool-habitats.json'
import habitatSchema from '@/data/habitats.json'

const habitatsData = rawHabitatsData as (typeof habitatSchema)[number][]
