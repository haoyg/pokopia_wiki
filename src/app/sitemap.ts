...
const staticPages = [
  ...
  { url: '/tools/habitat-planner', priority: '0.7', changefreq: 'weekly' },
  { url: '/tools/recipe-calculator', priority: '0.7', changefreq: 'weekly' },
  { url: '/tools/team-builder', priority: '0.7', changefreq: 'weekly' },
  { url: '/tools/spawn-tracker', priority: '0.7', changefreq: 'weekly' },
